...
run("python3", [
  ...
  "skills/dev-assets-context/scripts/dev_asset_common.py",
  "skills/dev-assets-context/scripts/dev_asset_context.py",
  "skills/dev-assets-setup/scripts/dev_asset_common.py",
  "skills/dev-assets-setup/scripts/init_dev_assets.py",
  "skills/dev-assets-sync/scripts/dev_asset_common.py",
  "skills/dev-assets-sync/scripts/dev_asset_sync.py",
  "skills/dev-assets-update/scripts/dev_asset_common.py",
  "skills/dev-assets-update/scripts/dev_asset_update.py",
